...
// Directories that are never traversed or scanned.
const skipDir = (p) =>
...
// File exemptions: test files only (plus index.ts barrels for the import cap
// below). Every source file — app.ts, main.tsx, router.tsx, components —
// must fit the limits.
const skipFile = (p) => p.endsWith(".test.ts") || p.endsWith(".prop.test.ts");
